...
.dxWeb_ucClearButton {
    background-image: url('/DXR.axd?r=1_31-yRpS9');
    -background-image: url('/DXR.axd?r=1_30-yRpS9'); /* for IE6 */
...
{
	background-image: url('/DXR.axd?r=1_14-yRpS9');
}
...
.dxpDropDownButton
{
    ...
    background: #e6e6e6 url('/DXR.axd?r=1_22-yRpS9') repeat-x top;
}
.dxpHoverDropDownButton
{
    border: 1px solid #606060;
    background: #f2f2f2 url('/DXR.axd?r=1_23-yRpS9') repeat-x top;
}
...
{
	border: 1px solid #7F7F7F;
	background: #E8E7E8 url('/DXR.axd?r=1_32-yRpS9') repeat-x;
	cursor: pointer;
	text-align: center;
	padding: 6px;
}
...
{
	background: #F4F4F4 url('/DXR.axd?r=1_34-yRpS9') repeat-x;
}
...
.dxtcScrollButtonDisabled
{
	cursor: default;
	border-color: #C3C3C3;
	background: #E6E7E8 url('/DXR.axd?r=1_33-yRpS9') repeat-x;
}
/* Misc */
.dxtcLeftAlignCell,
...
.dxucBrowseButton
{
	padding: 3px 8px 4px;
	border: 1px solid #7F7F7F;
	background: #E0DFDF url('/DXR.axd?r=1_39-yRpS9') repeat-x top;
}
...
{
	border: 1px solid #606060;
	background: #F2F2F2 url('/DXR.axd?r=1_40-yRpS9') repeat-x top;
}
...
{
	background: url('/DXR.axd?r=1_29-yRpS9') repeat;
	font-size: 0px;
	line-height: 0px;
}
.dxsplLCC
...
.dxtvControl .dxtv-ln
{
	background: url('/DXR.axd?r=1_37-yRpS9') repeat-y;
	vertical-align: top;
}
...
.dxtvControl .dxtv-elb
{
	background: url('/DXR.axd?r=1_35-yRpS9') no-repeat;
}
...
.dxtvControl.dxtvRtl .dxtv-elb
{
	background-image: url('/DXR.axd?r=1_36-yRpS9');
}
...
{
	width: 3px;
	background: url('/DXR.axd?r=1_12-yRpS9') repeat-y right;
	border-width: 0px;
}
...
{
    background-image: url('/DXR.axd?r=2_26-QZRN7');
    -background-image: url('/DXR.axd?r=2_25-QZRN7'); /* for IE6 */
    background-repeat: no-repeat;
    background-color: transparent;
}
...
{
	background-image:  url('/DXR.axd?r=2_22-QZRN7');
}
.dxeTBVSys .dxeTBTrack
{
	background-image:  url('/DXR.axd?r=2_23-QZRN7');
}
...
{
	background-image:  url('/DXR.axd?r=2_12-QZRN7');
}
.dxeTBVSys .dxeTBBarHighlight
{
	background-image:  url('/DXR.axd?r=2_13-QZRN7');
}
...
.dxeTBHSys .dxeTBItem
{
	background-image:  url('/DXR.axd?r=2_18-QZRN7');
}
.dxeTBHSys .dxeTBBScaleSys .dxeTBItem
{
	background-image:  url('/DXR.axd?r=2_16-QZRN7');
}
.dxeTBVSys .dxeTBItem 
{
	background-image:  url('/DXR.axd?r=2_19-QZRN7');
}
.dxeTBVSys .dxeTBBScaleSys .dxeTBItem
{
	background-image:  url('/DXR.axd?r=2_17-QZRN7');
}
...
{
	background-image: url('/DXR.axd?r=2_20-QZRN7');
}
.dxeTBVSys .dxeTBSmallTick
{
	background-image: url('/DXR.axd?r=2_21-QZRN7');
}
.dxeTBHSys .dxeTBBScaleSys .dxeTBLargeTick
{
	background-image: url('/DXR.axd?r=2_14-QZRN7');
}
.dxeTBVSys .dxeTBBScaleSys .dxeTBLargeTick
{
	background-image: url('/DXR.axd?r=2_15-QZRN7');
}
...
.dxeSpinLargeDecButton
{
	...
	background: #e6e6e6 url('/DXR.axd?r=2_8-QZRN7') repeat-x top;
}
.dxeSpinIncButton
{
	background: #F0F0F0 url('/DXR.axd?r=2_11-QZRN7') repeat-x top;
}
.dxeSpinDecButton
{
	background: #E6E6E6 url('/DXR.axd?r=2_10-QZRN7') repeat-x top;
}
...
{
	font-size: 12px;
	background: #e5e5e5 url('/DXR.axd?r=2_6-QZRN7') repeat-x top;
...
{
	background: #F2F2F2 url('/DXR.axd?r=2_9-QZRN7') repeat-x top;
	border: 1px Solid #606060;
}
.dxeCalendarButtonHover
{
	background: url('/DXR.axd?r=2_7-QZRN7') repeat-x top;
}
...
.dxbButton
{
	...
	vertical-align: middle;
	border: 1px solid #7F7F7F;
	background: #E0DFDF url('/DXR.axd?r=2_4-QZRN7') repeat-x top;
	padding: 1px;
	cursor: pointer;
}
.dxbButtonHover
{
	color: #000000;
	background: #F2F2F2 url('/DXR.axd?r=2_5-QZRN7') repeat-x top;
	border: 1px solid #606060;
}
.dxbButtonChecked
{
...
.dxTreeList_DragAndDropNode {
    background-image: url('/DXR.axd?r=6_12-exbs6');
    -background-image: url('/DXR.axd?r=6_11-exbs6'); /* for IE6 */
    background-repeat: no-repeat;
    background-color: transparent;
}
...
.dxtlLineRoot
{
	background: White url('/DXR.axd?r=6_9-exbs6') repeat-y top center;
}

.dxtlLineFirst
{
	background-image: url('/DXR.axd?r=6_3-exbs6');
}
.dxtlLineMiddle
{
	background-image: url('/DXR.axd?r=6_7-exbs6');
}
.dxtlLineLast
{
	background-image: url('/DXR.axd?r=6_5-exbs6');
}

.dxtlLineFirstRtl
{
	background-image: url('/DXR.axd?r=6_4-exbs6');
}
.dxtlLineMiddleRtl
{
	background-image: url('/DXR.axd?r=6_8-exbs6');
}
.dxtlLineLastRtl
{
	background-image: url('/DXR.axd?r=6_6-exbs6');
}
