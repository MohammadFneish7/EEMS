...
Public Class emptyCouterHistory
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "EEMS.emptyCouterHistory.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedemptyCouterHistory
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As emptyCouterHistory = New emptyCouterHistory()
        rpt.Site = Me.Site
        Return rpt
    End Function
